            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color:        isUser ? AppColors.surface2 : AppColors.surface3,
...
class _BotAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    width: 30, height: 30,
    decoration: BoxDecoration(
      gradient: AppColors.primary, borderRadius: BorderRadius.circular(9)),
...
class _TypingDots extends StatefulWidget {
  const _TypingDots();
  @override
  State<_TypingDots> createState() => _DotsState();
}

class _DotsState extends State<_TypingDots> with SingleTickerProviderStateMixin {
